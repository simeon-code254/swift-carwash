...
const Chat: React.FC = () => {
  ...
  const getParticipantCount = () => {
    if (!chat) return { workers: 0, admins: 0 };
    const workers = chat.participants.filter(p => p.role === 'worker').length;
    const admins = chat.participants.filter(p => p.role === 'admin').length;
  ...
  const { workers, admins } = getParticipantCount();
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <div className="flex items-center space-x-2 text-white/80 text-sm">
                  ...
                  <span>•</span>
                  <span>{workers} workers, {admins} admins</span>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 h-[700px] flex flex-col overflow-hidden backdrop-blur-sm">
          ...
          <div 
            ...
            className="flex-1 overflow-y-auto p-6 space-y-4 bg-gradient-to-b from-gray-50 via-blue-50/30 to-white"
            style={{
                      ...
                      <div className={`max-w-md lg:max-w-lg px-4 py-3 rounded-2xl shadow-lg backdrop-blur-sm ${
                        ...
                        {!isOwnMessage(message) && (
                          <div className="flex items-center space-x-2 text-xs font-medium text-gray-500 mb-2">
                            ...
                            {chat.participants.find(p => p.userId === message.sender._id)?.role === 'admin' && (
            ...
            {showFileUpload && selectedFile && (
              <div className="mb-4 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-blue-200/50">
                ...
                <button
                  ...
                  className="mt-3 w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-2 px-4 rounded-lg hover:from-blue-600 hover:to-purple-700 disabled:opacity-50 transition-all duration-200 shadow-lg"
                >
            ...
            <form onSubmit={sendMessage} className="flex space-x-3">
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white/80 backdrop-blur-sm transition-all duration-200"
                  disabled={sending}
                />
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  className="p-3 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-2xl transition-all duration-200"
                >
                ...
                <button
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-2xl hover:from-blue-600 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center space-x-2 shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                  {sending ? (
